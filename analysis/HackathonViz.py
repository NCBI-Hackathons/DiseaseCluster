...
from bokeh.models import CustomJS, ColumnDataSource, Panel, HoverTool, CategoricalColorMapper
...
def makePlot(source):
    ...
    p.circle(x='comp 0',y='comp 1', size = 0.5, hover_color ="black",source=source, color='tissue')
